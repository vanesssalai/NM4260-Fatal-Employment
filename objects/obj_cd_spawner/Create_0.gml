...
spawn_items = function() {
    repeat(count) {
        ...
        for (var attempt = 0; attempt < max_attempts; attempt++) {
            ...
            var has_collision = (collision_point(random_x, random_y, obj_no_spawn_zone, false, true) || collision_point(random_x, random_y, obj_collider, false, true));
